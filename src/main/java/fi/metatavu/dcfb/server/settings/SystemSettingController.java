package fi.metatavu.dcfb.server.settings;
...
import fi.metatavu.dcfb.server.persistence.dao.SystemSettingDAO;
import fi.metatavu.dcfb.server.persistence.model.SystemSetting;
