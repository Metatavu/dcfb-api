package fi.metatavu.dcfb.server.liquibase;
...
public class LiquibaseProducer {
  ...
  @Resource (lookup = "java:jboss/datasources/dcfb-api")
  ...
  public CDILiquibaseConfig createConfig() {
    ...
    config.setChangeLog("fi/metatavu/dcfb/server/liquibase/changelog.xml");
